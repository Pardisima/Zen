...
def crear():
    ...
    db.session.add(tarea) # Añadir el obj tarea a la bd
    db.session.commit() # Ejecutar la operacion pendiente de la bd
    db.session.close() # Cerramos la conexion con la bd
